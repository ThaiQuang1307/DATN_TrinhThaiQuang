...
const CalendarCustom = (props) => {
    ...
    return(
        <div className={classnames('calendar-custom pd-0', className, disabled && 'disabled-date-picker')} 
            ref={isRenderInput ? calendarRef : null}>
            {
                isRenderInput &&
                <div className='container-input pd-0'>
                    <input className={classnames('w-100 bg-white', classNameInput)} 
                        value={
                            displayMode === 'date' ? 
                    ...
                    <div className='btn-icon-input'>
                        {iconInput || <i className='far fa-calendar-alt' onClick={onToggleShowCalendar}></i> }
                    </div>
                    {
